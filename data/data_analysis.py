...
if __name__ == '__main__':
    ...
    # File paths (Currently considering training data, however test data can be analyzed by changing the following paths)
    save_path = "./cleaned_files"
    concept_path = "./train_data/partners/concept"
    text_path = "./train_data/partners/txt"
    concept_path1 = "./train_data/beth/concept"
    text_path1 = "./train_data/beth/txt"
    counter = 0
    
    if not os.path.exists(save_path):   # If path does not exist, then make a new one
    ...
    # Plotting Histogram
    plot_histogram(super_prob_list, 'Average Problem Concepts Distribution', 'Problem concepts per file', 3)
    plot_histogram(super_treat_list, 'Average Treatment Concepts Distribution', 'Treatment concepts per file', 3)
    plot_histogram(super_test_list, 'Average Test Concepts Distribution', 'Test concepts per file', 3)
